...
def main(data_wake, data_nowake, p_train_val=0.9, p_test=0.1,
	...
	file_name = "hyperparameter_unet_sweep"
	...
	for k in range(hp_len):
		...
		print("-"*20)
		bce_weight = hp_dict['bce_weight'][k]
		unet_learning_rate = hp_dict['learning_rate'][k] 
		unet_weight_decay = hp_dict['weight_decay'][k] 
...
if __name__ == "__main__":
	...
	#hp_file_name = "hyperparameters.txt"
	hp_file_name = "hyperparameters_last4.txt"
